...
from operations_center.multi_agent_troubleshooter.src.prompts.cpu_agent_prompt import (
    CPU_AGENT_SYSTEM_PROMPT,
)


class CPUAgent(BaseAgent):
    """Troubleshooting agent focused on CPU-related incident evidence."""
    ...
    def investigate(self, incident: str) -> AgentFinding:
        """Investigate CPU-related evidence in an incident."""
